...
In practice attendance has not been a problem so far. We usually have at least 90% of the company there, and our surveys show that people appreciate the conferences. Also, our "happiness index":happiness-index.html usually makes a small jump up after each conference (since we usually solve ome of the pain points that the happiness survey revealed).
