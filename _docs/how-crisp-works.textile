...
* *No gold on the table* - we don't tried to build financial value in the company.
...
See "Economic model":economic-model.html for more details on how money flows through the system. 
