...
h2. How do we handle conflicts, such as two consulants competing for the same client gig?
...
We've found that monetary incentive schemes invite suboptimization (yes, even in sales). People tend to focus on whatever gives them a bigger bonus, instead of what truly benefits the company. Instead we just pay a good fee and trust that the business developer works in the best interests of the company (just like everyone else at Crisp).

Monetary incentives are often pitched as way to motivate people to work smart and improve, but we find that transparancy and feedback is a much simpler and better way. 
