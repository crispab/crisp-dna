...
Anyone at Crisp can organize a course (or any kind of event), and when they do so they implicitely take on the Producer role for that course. 
...
he Producer doesn't necessarily have to teach the course (although that's the most common case). Sometimes a producer will invite a "star" (someone outside of Crisp who is a well-known "guru" within his/her field) and host or co-teach a course.
...
# Joe asks the "office team":office-team.html to set up a registration page. He's tought this course before, so they copy-paste from last course instance.
...
# Registrations start coming in. We have a home-grown tool to process registrations and send email confirmations. Course registartions automatically end up in Google Spreadsheet.
# The office team sends invoices to participants, and follows up payment.
# About a week before the course, the office team send a welcome email to the course participants
...
# The office team send an email to all course participants with link to course materials and such. They also add the course participants to our mailing list for future event notifications (they can ofcourse opt out at any time)
...
Together we have a really big network so most courses work out. In some cases, however, the registrations just don't come in, and if it's really bad we have to cancel.
...
This model works as long as nobody gets too wreckless! Too many canceled courses would hurt the Crisp brand (see "how we build the brand":brand-building). So far that hasn't been a problem though.
