...
# Start editing! The articles are all in the _docs folder, and the table of contents is in _data. Try opening _docs/index.md, and press the little pencil icon on the top right to edit it, and then commit. 
...
Another option is to skip the techy stuff (cloning and forking), and just steal the bits you like anyway. 
