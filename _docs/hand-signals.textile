...
We used the input to continuously tweak the vision statements, and by the end of the conference we had "two vision statements":visions.html with 100% consensus (= no thumb down or thumb sideways). 
